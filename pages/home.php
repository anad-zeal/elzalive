    ...
    <section class="body-paragraphs" aria-labelledby="home-page-heading">
        ...
        <p>
            <a href="/restoration?showSlideshow=true" class="dropcap" data-gallery="restoration"
                aria-label="Go to Restoration Projects">R</a>estoration Projects — DOGs Astral travel to any point in the
            universe is now possible via the implementation of
