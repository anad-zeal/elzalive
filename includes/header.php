...
<head>
    ...
    <script type="text/javascript" <link rel="icon" href="/favicons/favicon.ico" sizes="any">
    < link rel = "icon"
    ...
    crossorigin >
        ...
        link
    href =
        "https://fonts.googleapis.com/css2?family=Bonheur+Royale&family=Montserrat:ital,wght@0,100..900;1,100..900&family=Poiret+One&family=Spectral:ital,wght@0,200..800;1,200..800&display=swap"
    rel = "stylesheet" >
    ...
    <?= nav_item("contact", "CONTACT", "/contact") ?>
        ...
        !--Galleries nav-- >
        <
        nav class = "top-grid main-nav galleries"
